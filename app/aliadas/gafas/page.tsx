  ...
  return (
    <div className="min-h-screen bg-black text-white px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mt-6">Gafas</h1>
        <p className="text-zinc-300 mt-3">
          Selección de gafas premium con diseño elegante y protección UV.
        </p>
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
          {["Aviador", "Cat Eye", "Rectangulares", "Vintage"].map((item) => (
            <div key={item} className="rounded-xl border border-amber-500/20 bg-zinc-900/80 p-5">
              ...
              <p className="text-sm text-zinc-300 mt-2">
                Modelos exclusivos con acabados dorados.
              </p>
            </div>
          ))}
        </div>
