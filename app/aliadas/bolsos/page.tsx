  ...
  const items: Product[] = [
    {
      ...
      description: "Compacto con herrajes dorados y textura suave.",
    },
    {
      id: 12,
      name: "Tote Milano",
      ...
      image:
        "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=900&h=900&fit=crop",
      description: "Espacioso y elegante para uso diario.",
    },
    {
      id: 13,
      name: "Bandolera Ciel",
      ...
      description: "Correa ajustable con detalles premium.",
    },
    {
      id: 14,
      name: "Mini Luxe",
      ...
      image:
        "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=900&h=900&fit=crop",
      description: "Ideal para eventos nocturnos.",
    },
  ];
